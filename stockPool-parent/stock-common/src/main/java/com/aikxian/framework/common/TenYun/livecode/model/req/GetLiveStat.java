...
public class GetLiveStat extends BaseReqParams{
	...
	public GetLiveStat(Integer appid, Integer extime, String sign, String channel_id, Integer pageNo, Integer pageSize) {
		super.setAppid(appid);
		super.setExpire_time(extime);
		super.setSign(sign);
		super.set_interface(LiveCodeConstant.GET_LIVE_STAT);
		this.page_no = pageNo;

package com.huanxian.core.util;
...
public class SecurityUtil {
	...
	private static final String salt = "stokc1fefhajflj";
	 /**
     * 译码数据源
     */
	...
	public static String encryptPassword(String password)  {
		...
		try {
			...
			ha256 = MessageDigest.getInstance("SHA-256");
			return new SecurityUtil().encode(md5.digest(ha256.digest((password + salt).getBytes())));
